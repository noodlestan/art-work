...
- Workspace architect briefing: `$PROJECT/art-domains/cli/workspace/_roadmap/_architect.md` — establishes records as the source of truth and the imperative, rehydratable command model.
